...
public class EjercicioVisualizaciondosFragment extends Fragment {



    public EjercicioVisualizaciondosFragment() {
    ...
    private void setupGif(View view) {
        ...
        Glide.with(this).load(R.drawable.movimientoojos2).into(imageView);
    }
}